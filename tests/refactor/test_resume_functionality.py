...
class TestResumeFunctionality:
    ...
    def test_textual_app_main_accepts_resume_parameter(self):
        ...
        with patch.object(OpenHandsApp, '__init__', return_value=None) as mock_init, \
    ...
    def test_conversation_runner_initialize_with_conversation_id(self):
        ...
        with patch('openhands_cli.refactor.conversation_runner.setup_conversation') as mock_setup:
            ...
            assert call_args[0][0] == test_uuid  # First positional argument should be conversation_id
    ...
    def test_simple_main_passes_resume_to_textual_main(self):
        ...
        with patch('openhands_cli.simple_main.create_main_parser') as mock_parser, \
    ...
    def test_app_initializes_conversation_with_resume_id(self, mock_visualizer_cls, mock_runner_cls):
        """Test that the app initializes conversation with resume ID during _initialize_main_ui."""
        test_uuid = uuid.uuid4()
